...
#include "WheelsSignalsCalculatorAdvanced.h"
constexpr static float X_DISTANCE_BETWEEN_WHEELS = 200;
constexpr static float Y_DISTANCE_BETWEEN_WHEELS = 300;

void WheelsSignalsCalculatorAdvanced::applyMoveForward(const float value) const {
...
void WheelsSignalsCalculatorAdvanced::applyMoveBackward(const float value) const {
...
void WheelsSignalsCalculatorAdvanced::applyRotationCw(const float value) const {
    wheelForwardLeft->setForward(value);
    wheelForwardRight->setBackward(value);
    wheelBackwardLeft->setForward(value);
    wheelBackwardRight->setBackward(value);
...
void WheelsSignalsCalculatorAdvanced::applyRotationCcw(const float value) const {
    wheelForwardLeft->setBackward(value);
    wheelForwardRight->setForward(value);
    wheelBackwardLeft->setBackward(value);
    wheelBackwardRight->setForward(value);
...
void WheelsSignalsCalculatorAdvanced::stopAll() const {
